                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" data-page-length='100'>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td> <a  onclick="ApproveReject('<?php echo($data->id) ?>',1)" href="javascript:void(0)"><i class="fa fa-check fa-x"></i> Approve </a>
                            <a  onclick="ApproveReject('<?php echo($data->id) ?>',2)" href="javascript:void(0)"><i class="fa fa-times fa-x"></i> Reject </a>
                          </td>
          ...
          var reason = $('#notes1').val();
           ...
           $.ajax({
               ...
               success:function(response){  //alert(response);return false;
                if ( action == 1){
                  window.location = '<?php echo base_url(); ?>/user/finance_approve_debits_view/'+id;
                }
                if ( action == 2){
                  window.location = '<?php echo base_url(); ?>index.php/user/finance_reject_debits_view/'+id;
                }
