          ...
          <div class="">
            ...
            <div>
              <div style="float: right;">
                      ...
                      <a class="btn btn-app" href="javascript:void(0);" onclick="alertuser2()"><i class="fa fa-paint-brush"></i> Clean Inventory </a>
                      
                      <a class="btn btn-app" href="javascript:void(0);" onclick="alertuser3()"><i class="fa fa-calculator"></i> Calculate Inventory </a>

                      <a class="btn btn-app "  href="<?php echo base_url(); ?>index.php/user/inventory_load_log"><i class="fa fa-files-o"></i> Inventory Upload Log </a>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form action="<?php echo base_url(); ?>user/import_inventorytransactions" class="dropzone">
                  ...
                  <a href="<?php echo base_url(); ?>user/inventorytransactions_view" class="btn btn-warning btn-round"> < BACK </a>
                </div>
