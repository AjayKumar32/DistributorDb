          ...
          <div class="">
            <div class="page-title">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Debit Transactions </small></h2>
                    <?php $obj=& get_instance(); ?>
                    <div style="float: right;">
                      <?php if(isset($obj->sectionPriv[3]) && !empty($obj->sectionPriv[3])){
                        foreach($obj->sectionPriv[3] as $topSection) {
                          if($topSection['module_id']==156){ ?>
                          <a class="btn btn-app delete_tab_rec" href="#" id='debittransactions'><?php echo $topSection['icon'].$topSection['module_name']; ?></a>
                          <?php }else{ ?>
                      ...
                      <a class="btn btn-app" href="<?php echo base_url(); ?>index.php/user/debits_load_history_view"><i class="fa fa-table"></i> Debits Load History</a>
                    </div>
                  -->
                </div>
