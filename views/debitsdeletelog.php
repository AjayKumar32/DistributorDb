                  ...
                  <div class="x_content">
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" data-page-length='100'>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><input type="checkbox" id="check-all<?php echo $data->id; ?>" class="flat" value="<?php echo $data->id; ?>" name="table_records"></td>
                    ...
                    <a class="btn btn-warning btn-round" href="<?php echo base_url(); ?>/user/debitstransactions_view"> < BACK </a>
                  </div>
                </div>
