              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>APPROVED DEBITS<span><?php if(!is_null($msg)) echo $msg;?></span></h2>
                    ...
                    <div style="float: right;">
                      ...
                      <!--
                      <a class="btn btn-app" href="<?php echo base_url().'index.php/user/export_approveddebits'?>"><i class="fa fa-file-excel-o"></i> Export </a>
                      -->
                    </div> 
                         ...
                         <td><?php if($data->status==0){
                          ...
                          <td><?php echo $data->customer_service_approved_rejected_by; ?></td>
                           <td><?php echo $data->customer_service_approved_rejected_date; ?></td>
                            ...
                            <td><a class="btn btn-success"  href="<?php echo base_url().'index.php/user/financiallyprocess_debit/'?><?php echo($data->id); ?>"><i class="fa fa-check fa-2x"></i> Submit </a></td>
