          ...
          <div class="">
            <div class="page-title">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Countries Cleanup for new Countries </small></h2>
               ...
               <th><input type="checkbox" id="check-all" class="flat"></th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $data->Country_New; ?></td>                                     
                          <td><a href="<?php echo base_url(); ?>/user/addnew_countriescleanup/<?php echo $data->id ?>/<?php echo $data->table ?>"><i class="fa fa-edit"></i></a></td>                                    
