                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div style="float: right;">
                      ...
                      <a class="btn btn-app" href="<?php echo base_url(); ?>index.php/user/add_territories_view"><i class="fa fa-plus"></i> Add </a>
                     <a class="btn btn-app delete_tab_rec" id="territories" href="#"><i class="fa fa-trash-o"></i> Delete </a>
