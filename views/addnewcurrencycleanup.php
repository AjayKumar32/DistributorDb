          ...
          <div class="">
            <div class="page-title">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Currency Cleanup for new Currencies </small></h2>
               ...
               <th><input type="checkbox" id="check-all" class="flat"></th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $data->Currency_New; ?></td>
                          <td><?php echo $data->Currency_Description; ?></td>                                     
                          <td><a href="<?php echo base_url(); ?>/user/addnew_currencycleanup/<?php echo $data->id ?>/<?php echo $data->table ?>/<?php echo $data->Type ?>"><i class="fa fa-edit"></i></a></td>                                    
